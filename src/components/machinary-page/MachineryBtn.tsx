...
// const MachinaryBtn: React.FC<MachinaryButtonProps> = ({onFilterChange,categories}) => {
...
//         className={activeFilter === "all" ? "bg-blue-600 text-white hover:bg-blue-700" : "border-gray-300 hover:bg-gray-200"}
...
//               : 'border-gray-300 hover:bg-[#e7eaee] '
//             }
//             key={i}
